    ...
    <div class="page">
                                ...
                                <div class="rd-navbar-main-element">
                                    <div class="rd-navbar-nav-wrap">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="#news">Novos Eventos
                                                    </a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="#services">Server
                                                    Status</a></li>
                                            <li class="rd-nav-item rd-nav-dropdown">
                                                Ranks
                                                <span class="dropdown-icon fa fa-chevron-down"></span>
                                                <ul class="rd-nav-dropdown-menu">
                                                    <li class="rd-nav-dropdown-item"><a class="rd-nav-dropdown-link"
                                                            href="#rank1">Bans</a></li>
                                                    <li class="rd-nav-dropdown-item"><a class="rd-nav-dropdown-link"
                                                            href="#rank2">Bons</a></li>
                                                    <li class="rd-nav-dropdown-item"><a class="rd-nav-dropdown-link"
                                                            href="#rank3">Rank 3</a></li>
                                                </ul>
                                            </li>

                                            <li class="rd-nav-item"><a class="rd-nav-link" href="#team">VTC</a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="#details">Detalhes dos Eventos</a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="#contacts">Empresas de
                                                    Transporte Virtual</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="section section-sm section-first bg-default text-center" id="services">
            <div class="container">
                <div class="row row-30 justify-content-center">
                    <div class="col-md-7 col-lg-5 col-xl-6 text-lg-left wow fadeInUp"><img
                            src="images/index-1-415x592.png" alt="" width="415" height="592" />
                    </div>
                        ...
                        <div class="row row-30">
                                ...
                                <article class="box-icon-modern box-icon-modern-custom">
                                    <div>
                                        ...
                                        <div class="box-icon-modern-decor"></div><a
                                            class="button button-primary button-ujarak" href="#">View All Services</a>
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-6 wow fadeInRight" data-wow-delay=".1s">
                                <article class="box-icon-modern box-icon-modern-2">
                                    ...
                                    <p class="box-icon-modern-text">Need specific software for your company? We are
                                        ready to develop it!
                                    </p>
                                </article>
                            </div>
                            <div class="col-sm-6 wow fadeInRight" data-wow-delay=".2s">
                                <article class="box-icon-modern box-icon-modern-2">
                                    ...
                                    <div class="box-icon-modern-decor"></div>
                                    <p class="box-icon-modern-text">Our experts provide custom products of any
                                        complexity for call
                                        centers.</p>
                                </article>
                            </div>
                            <div class="col-sm-6 wow fadeInRight" data-wow-delay=".3s">
                                <article class="box-icon-modern box-icon-modern-2">
                                    ...
                                    <div class="box-icon-modern-decor"></div>
                                    <p class="box-icon-modern-text">We can also offer you reliable cloud development
                                        solutions.</p>
                                </article>
                            </div>
                        </div>
                        ...
                        <div class="row row-30 justify-content-end text-right">
                            <div class="col-sm-7">
                                ...
                                <div class="group-sm group-middle group justify-content-end"><a
                                        class="button button-primary button-ujarak" href="#modalCta"
                                        data-toggle="modal">Get in Touch</a><a
        ...
        <section class="section section-sm section-fluid bg-default text-center" id="projects">
            <div class="container-fluid">
                ...
                <p class="quote-jean wow fadeInRight" data-wow-delay=".1s">In our portfolio, you can browse the latest
                    products
                    developed for our clients for different corporate purposes. Our qualified team of interface
                    designers and
                    software developers is always ready to create something unique for you.</p>
                <div class="isotope-filters isotope-filters-horizontal">
                    ...
                    <ul class="isotope-filters-list" id="isotope-3">
                        ...
                        <li><a href="#" data-isotope-filter="Type 2" data-isotope-group="gallery">Custom Software</a>
                        </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tabs-6-1">
                                    ...
                                    <p>We regularly upload new free apps to our website, which is fully accessible to
                                        our clients and
                                        subscribers. You can also find out about free apps in our blog.</p>
                                ...
                                <div class="tab-pane fade" id="tabs-6-2">
                                    ...
                                    <p>Every app we develop has built-in social support that allows you to stay
                                        ...
                                        on Facebook, Instagram, Twitter and other networks.</p>
                                    <div class="group-sm group-middle"><a class="button button-secondary button-pipaluk"
                                            href="#modalCta" data-toggle="modal">Get in touch</a><a
                                            class="button button-default-outline button-wapasha" href="#">Learn More</a>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tabs-6-3">
                                    ...
                                    <p>Every customer of RatherApp can get access to our friendly and qualified 24/7
                                        support via chat or
                                        phone. Fell free to ask us any question!</p>
                                    <div class="group-sm group-middle"><a class="button button-secondary button-pipaluk"
                                            href="#modalCta" data-toggle="modal">Get in touch</a><a
                                            class="button button-default-outline button-wapasha" href="#">Learn More</a>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tabs-6-4">
                                    ...
                                    <p>All our apps are designed to have great usability in order to easily operate our
                                        applications. That
                                        is why our software has high ratings and lots of awards.</p>
                                    <div class="group-sm group-middle"><a class="button button-secondary button-pipaluk"
                                            href="#modalCta" data-toggle="modal">Get in touch</a><a
                                            class="button button-default-outline button-wapasha" href="#">Learn More</a>
                                    </div>
                        ...
                        <article class="quote-modern quote-modern-custom">
                            ...
                            <div class="quote-modern-text">
                                <p class="q">RatherApp offers a high caliber of resources skilled in Microsoft Azure
                                    .NET, mobile and
                                    Quality Assurance. They became our true business partners over the past three years.
                                </p>
                            </div>
                        </article>
                    </div>
                        ...
                        <article class="quote-modern quote-modern-custom">
                            ...
                            <div class="quote-modern-text">
                                <p class="q">RatherApp powered us with a competent team to develop products for banking
                                    services. The
                                    team has been delivering results within budget and time, which is amazing.</p>
                            </div>
                        </article>
                    </div>
                        ...
                        <article class="quote-modern quote-modern-custom">
                            ...
                            <div class="quote-modern-text">
                                <p class="q">RatherApp is a highly skilled and uniquely capable firm with multitudes of
                                    talent on-board.
                                    We have collaborated on a number of diverse projects that have been a great success.
                                </p>
                            </div>
                        </article>
                    </div>
